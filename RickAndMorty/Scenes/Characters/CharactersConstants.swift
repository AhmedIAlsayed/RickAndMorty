...
struct CharactersConstants {
    ...
    ///
    static let characterCellReuseIdentifier: String = String(
        describing: CharacterTableViewCell.self
    )
    
    /// Section Header View
    ///
    static let headerReuseIdentifier: String = String(
        describing: FiltersHeaderView.self
    )
    static let heightForHeader: CGFloat = 48.0

    /// Filter CollectionView Cell
    ///
    static let filterCellReuseIdentifier: String = String(
        describing: FilterCollectionViewCell.self
    )
